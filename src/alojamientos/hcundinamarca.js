...
import hospedajeCundiJson from '../jsonfiles/alojamientos/cundinamarca.json'
...
function FuncHospedajesCundinamarca() {

    let hospedajes = hospedajeCundiJson
...
export default FuncHospedajesCundinamarca;