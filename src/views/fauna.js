...
class FuncFauna extends React.Component {
                    ...
                    <div className="container">
                        <div className="row-animal">
                            ...
                            <div className="col-animal">
                                <div>
                                    <div>
                                        <img className="img-animal" src="imgs/fauna/1.png" alt="cocuy" />
                                    </div>
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Oso de Anteojos</b></h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <div>
                                        <img className="img-animal" src="imgs/fauna/3.png" alt="cocuy" />
                                    </div>
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Condor</b></h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <div>
                                        <img className="img-animal" src="imgs/fauna/4.png" alt="cocuy" />
                                    </div>

                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Gallito de roca</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/5.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Loro Orejiamarillo</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/6.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Mariposa Monarca</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/7.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Jaguar <br /><br /> </b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/8.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Guatin <br /><br /></b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/9.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Mariposa transparente</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/10.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Mono lanudo</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/11.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Mono araña marron</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/13.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Perezoso de tres dedos</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/14.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Loro de anteojos</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/15.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Pudú del norte</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/16.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Zorro colorado</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/17.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Tapir andino</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/18.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Rana toro</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/19.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Colibri angel</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/20.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Aguila andina</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/fauna/12.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Paujil</b> </h3>
                                    </div>
                                </div>
                            </div>
                        </div>
