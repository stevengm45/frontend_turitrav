...
class FuncFlora extends React.Component {
                    ...
                    <div className="container">
                        <div className="row-animal">
                            ...
                            <div className="col-animal">
                                <div>
                                    <div>
                                        <img className="img-animal" src="imgs/flora/1.png" alt="cocuy" />
                                    </div>
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Arbol colorado</b></h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <div>
                                        <img className="img-animal" src="imgs/flora/2.png" alt="cocuy" />
                                    </div>
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Eucalipto</b></h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <div>
                                        <img className="img-animal" src="imgs/flora/3.png" alt="cocuy" />
                                    </div>
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Flor Andina</b></h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <div>
                                        <img className="img-animal" src="imgs/flora/4.png" alt="cocuy" />
                                    </div>

                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Flor Buchon</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/flora/12.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Orquidea</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/flora/6.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Flor Retamo</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/flora/7.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Frailejon </b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/flora/8.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Helecho</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/flora/9.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Ocobo</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/flora/10.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Palama de Cera</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/flora/11.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Roble colombiano</b> </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-animal">
                                <div >
                                    <img className="img-animal" src="imgs/flora/5.png" alt="cocuy" />
                                    <div className="card-body">
                                        <h3 className="descrip-animal"><b>Flor de Cafe</b> </h3>
                                    </div>
                                </div>
                            </div>
                        </div>
